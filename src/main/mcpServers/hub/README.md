...
A built-in MCP server that aggregates all active MCP servers in The Boss and exposes them through **meta-tools**.

This server is the core component of The Boss’s **Auto MCP Mode**.
