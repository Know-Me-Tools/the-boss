...
const { invokeMock, persistExchangeMock, searchMock, rerankMock } = vi.hoisted(() => ({
  invokeMock: vi.fn(),
...
describe('SessionMessageService knowledge retrieval', () => {
  ...
  it('falls back to agent knowledge, augments the prompt, emits citation events, and persists a citation block', async () => {
