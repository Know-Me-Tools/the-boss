import type { PreparedSkillContext } from './buildSkillStreamParts'

const SKILL_SYSTEM_OPEN = '<activated_skills>'
const SKILL_SYSTEM_CLOSE = '</activated_skills>'

export function appendSkillContextToPrompt(basePrompt: string, preparedSkills: PreparedSkillContext[]): string {
