# The Boss AI Core 架构文档

> **版本**: v4.0 (ToolFactory + providerToolPlugin 统一工具注入)
> **更新日期**: 2026-03-20
> **适用范围**: The Boss v1.8.1+

本文档详细描述了 The Boss 从用户交互到 AI SDK 调用的完整数据流和架构设计，是理解应用核心功能的关键文档。
...
- **Plugin**: The Boss 层面的功能扩展（Reasoning, ToolUse, WebSearch）
