export enum IpcChannel {
  ...
  Artifact_GetRuntimeProfiles = 'artifact:get-runtime-profiles',
  Artifact_GetThemes = 'artifact:get-themes',
  Artifact_GetPackageRegistry = 'artifact:get-package-registry',
  ...
  Services_InvokeTool = 'services:invoke-tool',
  Services_InvokeOperation = 'services:invoke-operation',
  Services_Subscribe = 'services:subscribe',
  Services_Unsubscribe = 'services:unsubscribe',
  Services_SubscriptionEvent = 'services:subscription-event',
  Services_TestConnection = 'services:test-connection',
  ...
  ApiServer_SetConfig = 'api-server:set-config',
