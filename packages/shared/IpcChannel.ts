export enum IpcChannel {
  ...
  App_InstallRustToolchain = 'app:install-rust-toolchain',
  ...
  AgentRuntime_GetSupervisorStatus = 'agent-runtime:get-supervisor-status',
  AgentRuntime_StopSupervisedSidecar = 'agent-runtime:stop-supervised-sidecar',
  AgentRuntime_KillSidecar = 'agent-runtime:kill-sidecar',
