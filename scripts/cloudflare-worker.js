// 配置信息
const config = {
  R2_CUSTOM_DOMAIN: 'theboss.ocool.online',
  R2_BUCKET_NAME: 'theboss',
  // 缓存键名
  CACHE_KEY: 'the-boss-latest-release',
...
async function checkNewRelease(env) {
  try {
    // 获取 GitHub 最新版本
    const githubResponse = await fetch('https://api.github.com/repos/Know-Me-Tools/the-boss/releases/latest', {
