...
async function getElectronVitestConfig() {
  const resolvedConfig =
    typeof electronViteConfig === 'function' ? await (electronViteConfig as () => Promise<any>)() : electronViteConfig

  const mainConfig = resolvedConfig.main
...
export default defineConfig(getElectronVitestConfig)
